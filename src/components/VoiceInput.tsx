  ...
  return (
    <button
      ...
      className={`p-3 rounded-full transition-all duration-300 ${
        isListening ? 'bg-red-100 text-red-500 scale-110' : 'bg-peri/10 text-peri hover:bg-peri/20'
      }`}
    >
...
// Lucide Icons Mock (Since we don't have standard import access in this environment for lucide-react directly, we'll use SVGs)
// Fixed: Removed conflicting imports from lucide-react
const Mic = ({ size }: { size: number }) => (
