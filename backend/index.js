...
import { getMockListings } from './routes/mockListings.js';
...
// Mock listings endpoint - returns mock data directly for development
app.get('/api/mock-listings', getMockListings);
